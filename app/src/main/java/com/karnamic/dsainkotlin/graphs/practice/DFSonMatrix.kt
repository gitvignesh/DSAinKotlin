 ...
 *
 * Return the number of unique paths from the top-left corner of Grid to the bottom-right corner such that all
 * traversed cells are land cells. You may only move vertically or horizontally through land cells.
 *
